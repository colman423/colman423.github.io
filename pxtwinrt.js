...
(function (pxt) {
    var winrt;
    (function (winrt) {
        var WinRTPacketIO = /** @class */ (function () {
            function WinRTPacketIO() {
            ...
            WinRTPacketIO.prototype.disposeAsync = function () {
                return Promise.resolve();
            };
            WinRTPacketIO.prototype.error = function (msg) {
                throw new Error(pxt.U.lf("USB/HID error ({0})", msg));
            };
            WinRTPacketIO.prototype.setConnecting = function (v) {
                this.connecting = v;
                if (this.onConnectionChanged)
                    this.onConnectionChanged();
            };
            WinRTPacketIO.prototype.isConnecting = function () {
                return this.connecting;
            };
            WinRTPacketIO.prototype.isConnected = function () {
                return !!this.dev;
            };
            WinRTPacketIO.prototype.reconnectAsync = function () {
                var _this = this;
                return this.disconnectAsync()
                    .then(function () { return _this.initAsync(); });
            };
            WinRTPacketIO.prototype.isSwitchingToBootloader = function () {
                expectingAdd = true;
                if (this.dev) {
                    expectingRemove = true;
                }
            };
            WinRTPacketIO.prototype.disconnectAsync = function () {
                if (this.dev) {
                    var d = this.dev;
                    delete this.dev;
                    try {
            ...
            WinRTPacketIO.prototype.sendPacketAsync = function (pkt) {
                if (!this.dev)
                    return Promise.resolve();
                var ar = [0];
            ...
            WinRTPacketIO.prototype.handleInputReport = function (e) {
            ...
            WinRTPacketIO.prototype.initAsync = function (isRetry) {
                var _this = this;
                ...
                return getDevicesPromise
                    ...
                    _this.dev.addEventListener("inputreportreceived", _this.handleInputReport);
                    return Promise.resolve();
                })
                    .finally(function () {
                    ...
                    return winrt.bootloaderViaBaud(_this)
                        .then(function () {
