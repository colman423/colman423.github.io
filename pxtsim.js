...
(function (pxsim) {
    ...
    var Runtime = /** @class */ (function () {
        ...
        Runtime.requestExtensionsDialog = function (query) {
            var r = pxsim.runtime;
            if (!r)
                return;
            Runtime.postMessage({
...
(function (pxsim) {
    ...
    var FRAME_ASPECT_RATIO = "aspectratio";
    ...
    var SimulatorDriver = /** @class */ (function () {
        ...
        SimulatorDriver.prototype.applyAspectRatioToFrame = function (frame, ratio) {
            ...
            if (r === undefined) {
                var rt = parseFloat(frame.dataset[FRAME_ASPECT_RATIO]);
                if (!isNaN(rt))
                    r = rt;
            }
